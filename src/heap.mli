...
module Elt : sig
  ...
  (** [value_exn t] return the value in the heap controlled by this token if the
      value is still in the heap.  Raise otherwise. *)
  val value_exn : 'a t -> 'a
end
...
module Unsafe : sig
  ...
  module Elt : sig
    ...
    (** [value t heap] return the value in the [heap] controlled by this token if the
