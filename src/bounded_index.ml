...
module Stable = struct
  ...
  let%test_module "V1" = (module Stable_unit_test.Make (struct
      ...
      let tests =
        ...
        ; make 999_999_999 0 1_999_999_999,
          "(index 999999999 of 0 to 1999999999)",
          "\253\255\201\154\059\000\253\255\147\053\119"
        ; make 1_000_000_000 1 2_000_000_000,
          "(index 1000000000 of 1 to 2000000000)",
          "\253\000\202\154\059\001\253\000\148\053\119"
        ]
    end))
end
