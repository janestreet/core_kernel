...
val fold_until
  :  'a t
  -> init:'accum
  -> f:('accum -> 'a -> ('accum, 'final) Core.Continue_or_stop.t)
  -> finish:('accum -> 'final)
  -> 'final
...
val of_hashtbl_keys : ('a, 'b) Core.Hashtbl.t -> 'a t
val to_hashtbl : 'key t -> f:('key -> 'data) -> ('key, 'data) Core.Hashtbl.t
val hashable : 'key t -> 'key Base__Hashable_intf.Hashable.t

module type Elt_plain = Core__.Hashtbl.Key_plain
module type Elt = Core__.Hashtbl.Key
module type Elt_binable = Core__.Hashtbl.Key_binable
...
module Using_hashable = Core.Hash_set.Using_hashable
module Poly = Core.Hash_set.Poly
module Make_plain = Core.Hash_set.Make_plain
module Make = Core.Hash_set.Make
module Make_binable = Core.Hash_set.Make_binable
module Make_plain_with_hashable = Core.Hash_set.Make_plain_with_hashable
module Make_with_hashable = Core.Hash_set.Make_with_hashable
module Make_binable_with_hashable = Core.Hash_set.Make_binable_with_hashable

module type M_of_sexp = Base__.Hash_set_intf.M_of_sexp
module type Sexp_of_m = Base__.Hash_set_intf.Sexp_of_m

module M = Core.Hash_set.M
...
module type M_quickcheck = Core__.Hash_set_intf.M_quickcheck
