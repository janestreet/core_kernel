...
module%test [@name "inline_unsigned_16"] _ = Make_inline_tests (struct
...
module%test [@name "inline_signed_16"] _ = Make_inline_tests (struct
...
module%test [@name "inline_unsigned_32_int"] [@tags "64-bits-only"] _ =
...
module%test [@name "inline_signed_32_int"] [@tags "64-bits-only"] _ =
Make_inline_tests (struct
    let ns =
      [ 0x3f20_3040
      ; Int64.to_int_exn 0x7f20_3040L
...
module%test [@name "inline_signed_64"] _ = Make_inline_tests (struct
    let ns =
...
module%test [@name "inline_tail_padded_fixed_string"] _ = struct
  let test_last_nonmatch_plus_one ~buf ~min_pos ~pos ~char ~expect =
    Private.last_nonmatch_plus_one ~buf:(Bytes.of_string buf) ~min_pos ~pos ~char = expect
  ;;
