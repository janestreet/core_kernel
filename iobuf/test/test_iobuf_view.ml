...
module%test Limits : module type of Iobuf.Limits = struct
  open Iobuf.Limits
  include T
...
module%test Hexdump : module type of Iobuf.Hexdump = struct
  open Iobuf.Hexdump
  include T
...
module%test Debug : module type of Iobuf.Debug = struct
  open Iobuf.Debug
  include T
