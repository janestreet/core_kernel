...
module Consume = struct
  ...
  type nonrec ('a, 'd, 'w, 'l) t__local = ('d, seek, 'l) t -> 'a constraint 'd = [> read ]
  type nonrec ('a, 'd, 'w, 'l) t = ('d, seek, 'l) t -> 'a constraint 'd = [> read ]
...
module Fill = struct
  type nonrec ('a, 'd, 'w, 'l) t__local = (read_write, seek, 'l) t -> 'a -> unit
    constraint 'd = [> read ]

  type nonrec ('a, 'd, 'w, 'l) t = (read_write, seek, 'l) t -> 'a -> unit
    constraint 'd = [> read ]
...
module Peek = struct
  ...
  type nonrec ('a, 'd, 'w, 'l) t__local = ('d, 'w, 'l) t -> pos:int -> 'a
    constraint 'd = [> read ]

  type nonrec ('a, 'd, 'w, 'l) t = ('d, 'w, 'l) t -> pos:int -> 'a
    constraint 'd = [> read ]
...
module Poke = struct
  type nonrec ('a, 'd, 'w, 'l) t__local = (read_write, 'w, 'l) t -> pos:int -> 'a -> unit
    constraint 'd = [> read ]

  type nonrec ('a, 'd, 'w, 'l) t = (read_write, 'w, 'l) t -> pos:int -> 'a -> unit
    constraint 'd = [> read ]
