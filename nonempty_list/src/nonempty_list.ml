...
module Stable = struct
  module V3 = struct
    module T = struct
      type%template 'a t = ( :: ) of 'a * ('a List.V1.t[@kind k])
      ...
      open struct
        type nonrec 'a t = ('a t[@kind k]) = ( :: ) of 'a * ('a List.V1.t[@kind k])
      end
...
type%template 'a t = ('a Stable.V3.t[@kind k]) = ( :: ) of 'a * ('a List.t[@kind k])
[@@kind k = (float64, bits32, bits64, word)]
[@@deriving compare ~localize, equal ~localize]
