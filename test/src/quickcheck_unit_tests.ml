...
let%expect_test "Quickcheck.Let_syntax" [@tags "64-bits-only"] =
  ...
  [%expect {|
    ...
    ((true L 810.87297628724627) (B -4_611_686_018_427_387_904))
    ((true A 2) (B 120_741))
    ((true a 2.2250738585072014E-308) (A "\225\026e"))
    ((true 6 0.023325874905367527) (A L))
    ((true ' 1.0620383014489319E+74) (B -402_023_890_565_925))
    ((false Q 1.1653657392500323E-155) (A "\235QLBLaX"))
    ((false 4 -0.125) (B 5_489_827_170_816_741))
    ((false p 6.1107598835878889) (A "\239JkPy"))
