(* OASIS_START *)
(* DO NOT EDIT (digest: bb61ca6e3533638f161435e148721f4e) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("core_kernel", OCamlbuildDocPlugin.doc_build "lib")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("core_kernel", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "OpN\228#\147\132\020\028\139\156\158\028\251#\128";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
